package com.tescomm.addresspickerlib;
...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
     ...
     */
    public void initData(List<YwpAddressBean.AddressItemBean> province) {
        if (province != null || province.size()>0) {
            ...
            mYwpAddressBean = new YwpAddressBean();
    ...
    public void flushCityList(List<YwpAddressBean.AddressItemBean> city){
        mYwpAddressBean.setProvince(city);
        mRvData.clear();
        mRvData.addAll(mYwpAddressBean.getCity());
        mAdapter.notifyDataSetChanged();
    }

    public void flushDistrictList(List<YwpAddressBean.AddressItemBean> district){
        mYwpAddressBean.setDistrict(district);
        mRvData.clear();
        mRvData.addAll(mYwpAddressBean.getDistrict());
        mAdapter.notifyDataSetChanged();
    }
